      ...
      <main>
        ...
        <div className="relative mx-auto max-w-7xl px-6 pt-32 lg:px-10 lg:pt-9">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-10 max-w-2xl text-base leading-8 text-white/75 sm:text-lg">
              ...
              CarbonX connects organizations, climate projects, and global buyers
              through a transparent marketplace for verified carbon credits.
          ...
          <div className="mt-24 border-t border-white/20">
            ...
            <div className="grid grid-cols-1 divide-y divide-white/15 md:grid-cols-3 md:divide-x md:divide-y-0">
              ...
              <div className="py-10 md:pl-10">
                ...
                <p className="mt-3 text-sm leading-6 text-white/60">
                  organizations and buyers participating in CarbonX
                </p>
        ...
        <div className="mx-auto max-w-6xl">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-600">
                CarbonX brings together projects, organizations, buyers,
      ...
      <div className="grid flex-1 gap-5 md:grid-cols-3">
        ...
        <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6 shadow-sm">
          ...
          <p className="mt-5 text-sm leading-7 text-slate-600">
            “CarbonX has provided our organization with a simple and
  ...
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="mx-auto max-w-4xl text-center">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-600">
        Join CarbonX and discover transparent, verifiable, and impactful
